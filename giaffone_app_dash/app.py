...
@app.callback(
    ...
    Output(dash.dependencies.ALL, 'style'),  # Alterar o layout de forma geral
...
def login(n_clicks, username, password):
    if username == "scat" and password == "1234":  # Simples validação de login
        return "", {'display': 'none'}, {'display': 'block'}  # Redireciona para o layout principal
    else:
        return "Usuário ou senha inválidos", {'display': 'none'}, {'display': 'none'}
